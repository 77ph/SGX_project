...
- [ ] Реализовать безопасное удаление чувствительных данных (использовать `sgx_secure_memset` вместо обычного `memset`)
- [ ] Добавить проверку на повторное использование nonce в транзакциях
